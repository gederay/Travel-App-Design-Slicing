        ...
        u = {
          ...
          setOptions: function (r) {
            ...
            l(),
              ...
              (f.scrollParents = { reference: n(e) ? x(e) : e.contextElement ? x(e.contextElement) : [], popper: x(t) });
            var s,
              p,
              d = (function (e) {
                var t = q(e);
        ...
        for (
          var o = n.mainAxis,
            ...
            b = [v].concat(g).reduce(function (e, n) {
              return e.concat(
                C(n) === M ? ue(t, { placement: n, boundary: p, rootBoundary: u, padding: c, flipVariations: h, allowedAutoPlacements: m }) : n
              );
            }, []),
            w = t.rects.reference,
            x = t.rects.popper,
